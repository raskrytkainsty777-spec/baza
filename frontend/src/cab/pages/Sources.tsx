          ...
          <Table.Tbody>
            {list.data?.totals && (
              <Table.Tr style={{ background: "var(--mantine-color-gray-0)", fontWeight: 600 }}>
                <Table.Td /><Table.Td>Итого</Table.Td><Table.Td /><Table.Td /><Table.Td /><Table.Td>{list.data.total !== list.data.totals.active ? <Text span c="dimmed" fw={400}>включено {list.data.totals.active} из {list.data.total}</Text> : ""}</Table.Td><Table.Td />
